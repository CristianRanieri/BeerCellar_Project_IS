        ...
        <form action="modificaProdotto" enctype="multipart/form-data" method="post">
            ...
            <div id="div_prodotto">
                ...
                <div id="div_dati_prodotto">
                    ...
                    <input type="text" value="<%=prodotto.getPrezzo()%>" id="prezzo" name="prezzo" pattern="^\d{1,3}\.\d{2}$" required>
                    ...
                    <input type="text" value="<%=prodotto.getTassoAlcolico()%>" id="tassoAlcolico" name="tassoAlcolico" pattern="^\d{1,2}\.\d{1,2}$" required>
                </div>
                ...
                <div id="div_descrizioneProdotto">
                    ...
                    <input type="text" id="nomeBirrificio" name="nomeBirrificio" value="<%=prodotto.getBirrificio()%>" pattern="^[a-zA-Z0-9 ]{3,30}$" required>
                </div>
            </div>
